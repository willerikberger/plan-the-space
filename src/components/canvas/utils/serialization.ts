 ...
 * Converts between runtime PlannerObject/Fabric state and the SerializedProject JSON format (v2/v3).
 * @dependencies types (PlannerObject, SerializedProject, SerializedProjectV3, SerializedObject, and related subtypes)
